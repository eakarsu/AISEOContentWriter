...
const FEATURE_SLUG = 'no-google-analytics-search-console-integrati';
const FEATURE_TITLE = 'No Google Analytics / Search Console integration';
const PROJECT = 'AISEOContentWriter';
